export const blogContent = [
    {
        subjectId: "1",
        subjectTitle: "React",
        subjectExcerpt: "React is an open-source JavaScript library developed by Facebook for building user interfaces, particularly single-page applications where a dynamic and high-performing user experience is crucial. It focuses on the view layer of the MVC (Model-View-Controller) architecture and enables developers to create reusable UI components. React utilizes a virtual DOM to efficiently update and render components, making it highly performant. ",
    ...
    },
    {
        subjectId: "4",
        subjectTitle: "Zod",
        subjectExcerpt: "Node.js is an open-source, cross-platform JavaScript runtime environment that allows developers to execute JavaScript code outside of a browser. Built on Chrome's V8 JavaScript engine, Node.js is known for its event-driven, non-blocking I/O model, which makes it ideal for building scalable network applications. It enables the development of server-side and networking applications with high throughput and low latency.",
