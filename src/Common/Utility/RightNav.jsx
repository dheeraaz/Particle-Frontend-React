...
const RightNav = () => {
  return (
    <div className='flex gap-4'>
      <form className=" flexVerCenter justify-between w-[340px] h-[38px] bg-white rounded-[20px] focus-within:shadow-md">
        ...
        <button className=" bg-transparent pointer-cursor mr-3">
