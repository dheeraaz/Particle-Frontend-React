...
const SubjectDescription = (props) => {
  ...
  return (
    <section className='my-6 flex gap-16 xl:my-5 xl:gap-14 justify-between items-center md:flex-col md:gap-4'>
    <div className='w-[547px] h-[278px] xl:w-[496px] xl:h-[252px] lg:w-[360px] lg:h-[220px] md:w-full md:h-full rounded-lg'>
